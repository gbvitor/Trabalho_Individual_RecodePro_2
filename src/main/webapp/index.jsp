        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link" href="./views/destinos.jsp">Destinos</a>
                    <a class="nav-link" href="./views/promoções.jsp">Promoções</a>
                    <a class="nav-link" href="./views/contatos.jsp">Contato</a>
                </div>
            </div>
